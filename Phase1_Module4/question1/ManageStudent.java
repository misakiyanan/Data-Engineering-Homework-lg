...
public class ManageStudent {
    ...
    public void saveData() throws IOException {
        ...
        System.out.println("信息已保存，安全退出系统");
        if (oos != null) {
            oos.close();
        }
    }
    ...
    public void loadData() throws IOException, ClassNotFoundException {
        ...
        System.out.println("欢迎进入学生信息管理系统，数据已加载");
        if (ois != null) {
            ois.close();
        }
    }
     ...
     * 增加学生信息到集合中
     */
    public void addStudent() throws IDAlreadyExistsException, InvalidAgeException, InvalidIDException {
     ...
     * 从集合中删除学生信息
     */
    public void deleteStudent() throws IDNotExistsException{
     ...
     * 修改学生信息从集合中
     */
    public void modifyStudent() throws IDNotExistsException, InvalidAgeException, InvalidIDException {
     ...
     * 查找学生信息从集合中
     */
    public void queryStudent() throws IDNotExistsException{
